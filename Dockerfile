...
RUN apk --no-cache --repository https://dl-cdn.alpinelinux.org/alpine/edge/main add icu-libs && apk --no-cache --repository https://dl-cdn.alpinelinux.org/alpine/edge/community add libavif gnu-libiconv 
